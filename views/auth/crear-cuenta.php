...
<form action="/crear-cuenta" method="POST" class="formulario">
    ...
    <div class="campo">
        ...
        <input type="tel" id="telefono" placeholder="Tú teléfono(opcional)" name="telefono" value="<?php echo s($usuario->telefono); ?>">
    </div>

    <div class="campo">
        <label for="email">Email</label>
        <input type="email" id="email" placeholder="Tú email" name="email" value="<?php echo s($usuario->email); ?>">
    </div>
