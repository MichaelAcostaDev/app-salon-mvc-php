...
function iniciarApp() {
  ...
  tabs(); // Cambia la seccion cuando se precione un tab
...
function seleccionarFecha() {
  ...
  inputFecha.addEventListener("input", function (e) {
    ...
    if ([4, 1].includes(dia)) {
      e.target.value = "";
      mostrarAlerta("Lunes y jueves no laboramos", "error", ".formulario");
      // console.log("Lunes y Jueves no laboramos");
    } else {
  ...
  try {
    ...
    if (resultado.resultado) {
      Swal.fire({
        icon: "success",
        title: "Cita creada",
        text: `Tu cita fue creada correctamente a las ${hora} el dia ${fecha} `,
        button: "OK",
      }).then(() => {
        setTimeout(() => {
